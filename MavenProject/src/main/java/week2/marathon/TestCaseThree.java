...
public class TestCaseThree {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//driver.findElement(By.xpath("//label[contains(text(),'F&B']/preceding-sibling::select")).click();		
		...
		//driver.findElement(By.xpath("//span[contains(@class,'control-indicator')]")).click();
